...
app.get("/updateBattingStats",async (req,res) => {
    var data=[
        { _id: '620be3bea9261146e0f043b8', name: 'Akil Bhai', runs: 9,ballsPlayed:8 },
        { _id: '621073ce0222251b60374fb3', name: 'Alam Bhai', runs: 0,ballsPlayed:0 },
        { _id: '620f1c8a74916272450ed3f0', name: 'Ali', runs: 0,ballsPlayed:0 },
        { _id: '620be3bea9261146e0f043a6', name: 'Aquib',runs: 0,ballsPlayed:0 },
        { _id: '62105b3f0222251b60374fb2', name: 'Asif masjidgali',runs: 4,ballsPlayed:4 },
        { _id: '620be3bea9261146e0f043ab', name: 'Atif',runs:0,ballsPlayed:0 },
        { _id: '620be3bea9261146e0f043aa', name: 'Azad Bhai',runs: 1,ballsPlayed:4 },
        { _id: '620be3bea9261146e0f043b7', name: 'Bikki', runs: 0,ballsPlayed:3 },
        { _id: '620be3bea9261146e0f043a5', name: 'Buni', runs: 8,ballsPlayed:8},
        { _id: '620be3bea9261146e0f043a7', name: 'Chotu',runs: 6,ballsPlayed:4 },
        { _id: '620c4ad74b18020bbe14c392', name: 'Dablu Bhai',runs: 23,ballsPlayed:15},
        { _id: '620be3bea9261146e0f043af', name: 'Danish', runs: 15,ballsPlayed:8 },
        ...
        { _id: '620be3bea9261146e0f043a4', name: 'Fayeque',runs: 6,ballsPlayed:2 },
        ...
        { _id: '620be3bea9261146e0f043b1', name: 'Paale', runs: 7,ballsPlayed:3 },
        { _id: '620be3bea9261146e0f043b3', name: 'Raj Bhai', runs: 31,ballsPlayed:13 },
        { _id: '620c527d4b18020bbe14c393', name: 'Rajji Bhai', runs: 0,ballsPlayed:0 },
        { _id: '620be3bea9261146e0f043b0', name: 'Sabbir Bhai', runs: 0,ballsPlayed:1 },
        { _id: '620be3bea9261146e0f043ae', name: 'Saddam Bhai', runs: 5,ballsPlayed:7 },
        { _id: '620be3bea9261146e0f043a3', name: 'Saif Ali',runs: 70,ballsPlayed:30 },
        { _id: '620f0af674916272450ed3ef', name: 'Samir',runs: 0,ballsPlayed:0 },
        { _id: '620c52be4b18020bbe14c396', name: 'Shakil Bhai',runs: 5,ballsPlayed:4 },
        { _id: '620be3bea9261146e0f043a8', name: 'Sheru Bhai',runs: 0,ballsPlayed:0 },
        { _id: '620be3bea9261146e0f043a9', name: 'Sohrab Bhai',runs: 30,ballsPlayed:13 },
        ...
        { _id: '620be3bea9261146e0f043b6', name: 'Wajid Bhai', runs: 4,ballsPlayed:4 },
...
app.get("/updateBowlingStats",async (req,res) => {
    ...
    var data=[
        { _id: '620be3bea9261146e0f043b8', name: 'Akil Bhai',runsGiven: 46,ballsDelivered:18,wickets:2},
        { _id: '620be3bea9261146e0f043a5', name: 'Buni',runsGiven: 26,ballsDelivered:18,wickets:1 },
        { _id: '620be3bea9261146e0f043b2', name: 'Faiz',runsGiven: 38,ballsDelivered:12,wickets:1 },
        ...
        { _id: '620be3bea9261146e0f043b3', name: 'Raj Bhai',runsGiven: 23,ballsDelivered:18,wickets:4 },
        { _id: '620be3bea9261146e0f043b0', name: 'Sabbir Bhai',runsGiven: 37,ballsDelivered:18,wickets:2},
        { _id: '620be3bea9261146e0f043ae', name: 'Saddam Bhai',runsGiven: 23,ballsDelivered:18,wickets:1  },
        { _id: '620be3bea9261146e0f043a3', name: 'Saif Ali',runsGiven: 27,ballsDelivered:12,wickets:1 },
...
app.get("/bowlingWickets",async (req,res) => {
    var data=await Player.find({wickets : {$gt : 0}}).sort({wickets:-1});
